...
import { http, authenticatedRoute, authenticatedWebSocketRoute } from '@libp2p/http'
import { pingHTTP } from '@libp2p/http-ping'
import { memory } from '@libp2p/memory'
import { ping } from '@libp2p/ping'
import { webSockets } from '@libp2p/websockets'
import { createLibp2p } from 'libp2p'
import type { WebServer, HTTP } from '@libp2p/http'
 ...
 */
export async function getHTTPOverLibp2pHandler (server: WebServer, listen: string = '/memory/address-1'): Promise<Libp2p<{ http: HTTP }>> {
